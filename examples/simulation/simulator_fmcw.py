...
class simulator_fmcw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.m_min_output_buffer = m_min_output_buffer = int((samp_up+samp_down+samp_cw)*2)
        self.m_max_output_buffer = m_max_output_buffer = 0
        ...
        self.radar_static_target_simulator_cc_0.set_min_output_buffer(m_min_output_buffer)
        self.radar_split_cc_0_0_0 = radar.split_cc(2, [int(x) for x in (samp_cw/decim_fac,samp_up/decim_fac,samp_down/decim_fac)], "packet_len")
        self.radar_split_cc_0_0_0.set_min_output_buffer(m_min_output_buffer)
        self.radar_split_cc_0_0 = radar.split_cc(1, [int(x) for x in (samp_cw/decim_fac,samp_up/decim_fac,samp_down/decim_fac)], "packet_len")
        self.radar_split_cc_0_0.set_min_output_buffer(m_min_output_buffer)
        self.radar_split_cc_0 = radar.split_cc(0, [int(x) for x in (samp_cw/decim_fac,samp_up/decim_fac,samp_down/decim_fac)], "packet_len")
        self.radar_split_cc_0.set_min_output_buffer(m_min_output_buffer)
        ...
        self.radar_signal_generator_fmcw_c_0.set_min_output_buffer(m_min_output_buffer)
        ...
        self.blocks_throttle_0.set_min_output_buffer(m_min_output_buffer)
        ...
        self.blocks_tagged_stream_multiply_length_0.set_min_output_buffer(m_min_output_buffer)
        self.blocks_multiply_conjugate_cc_0 = blocks.multiply_conjugate_cc(1)
        self.blocks_multiply_conjugate_cc_0.set_min_output_buffer(m_min_output_buffer)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_add_xx_0.set_min_output_buffer(m_min_output_buffer)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 0.1, 0)
        self.analog_noise_source_x_0.set_min_output_buffer(m_min_output_buffer)
    ...
    def set_samp_up(self, samp_up):
        ...
        self.set_m_min_output_buffer(int((self.samp_up+self.samp_down+self.samp_cw)*2))
    ...
    def get_m_min_output_buffer(self):
        return self.m_min_output_buffer

    def set_m_min_output_buffer(self, m_min_output_buffer):
        self.m_min_output_buffer = m_min_output_buffer

    def get_m_max_output_buffer(self):
        return self.m_max_output_buffer

    def set_m_max_output_buffer(self, m_max_output_buffer):
        self.m_max_output_buffer = m_max_output_buffer
